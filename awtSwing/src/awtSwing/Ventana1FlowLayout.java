...
public class Ventana1FlowLayout extends JFrame{

	  private JButton boton1, boton2, boton3;

	    public Ventana1FlowLayout() {
	    ...
	    public static void main (String[] args) throws Exception {
	    	...
	    	Ventana1FlowLayout v1 = new Ventana1FlowLayout();    //ventana1 extiende a JFrame, por tanto ventana1 es un JFrame
	        v1.setTitle("ventana 1");
	        v1.boton1 = new JButton("Login");//instanciar componente boton
	        v1.add(v1.boton1);//añadir componente boton a la ventana
	        ...
	        v1.add(v1.boton3);
	        v1.setVisible(true);//hacer visible la ventana al final para prevenir que no aparezca algún componente
	    }
}
